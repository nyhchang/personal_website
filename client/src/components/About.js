...
export default class About extends Component {
  render() {
    return (
        <section>
          <title>Nathan Chang</title>
          <p>I'm a up and coming web developer, looking to build useful, functional, and compact websites. I initially graduated from Cal Poly
